...
export default function App() {
  ...
  const [isSidebarOpen, setIsSidebarOpen] = useState(true); // Members Sidebar
  const [isReferenceOpen, setIsReferenceOpen] = useState(true); // Complaints Sidebar
  ...
  return (
    <div className="relative flex w-full h-screen p-4 gap-3.5 overflow-hidden">
      {/* Animated Blobs */}
      ...
      {/* MAIN CHAT AREA */}
      <main id="chat-panel" className="relative z-10 flex-1 glass-panel rounded-[18px] flex flex-col overflow-hidden">
        {/* HEADER */}
        <header id="chat-header" className="h-[66px] border-b border-glass-border bg-white/4 px-5 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div id="room-icon" className="w-[38px] h-[38px] rounded-[10px] accent-gradient flex items-center justify-center text-[18px] shadow-[0_4px_14px_rgba(129,140,248,0.4)]">
              💬
            </div>
            <div>
              <h2 className="text-[16px] font-semibold tracking-[0.01em]">Debate Room</h2>
              <p className="text-[12px] text-slate-100/50 mt-px">Share ideas, argue boldly.</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div id="header-pill" className="flex items-center gap-1.5 text-[12px] font-medium text-slate-100/50 bg-glass border border-glass-border rounded-[20px] px-3.5 py-1.5">
      ...
      <AnimatePresence>
        {isReferenceOpen && (
          <motion.aside
            ...
            className="z-10 w-[300px] h-full glass-panel rounded-[18px] flex flex-col overflow-hidden"
          >
