...
export const Sidebar = ({ theme, toggleTheme }) => {
  const items = [
    ...
    { icon: ListTodo, label: "Recent Complaints", path: "/complaints" },
    { icon: User, label: "Your Complaints", path: "/my-complaints" },
...
export const BottomNav = ({ theme, toggleTheme }) => {
  const items = [
    ...
    { icon: ListTodo, label: "Complaints", path: "/complaints", badge: 2 },
    { icon: User, label: "Mine", path: "/my-complaints" },
